          ...
          <div class="col-sm-6">
            <div class="contactinfo">
              <ul class="nav nav-pills" >
                <li><a href="#"><i class="fa fa-phone"></i>  +91  9687458110</a></li>
                <li><a href="#"><i class="fa fa-envelope"></i> Fammsofficial@gmail.com</a></li>
              </ul>
            </div>
          </div>
          <div class="col-sm-6">
        ...
        <div class="row">
          <div class="col-md-4 clearfix">
            <div class="logo pull-left">
              <a href="<?php echo web_root?>"><img src="images/home/logoblack.png" alt="" /></a>
            </div> 
          </div>
        ...
        <div class="row">
          <div class="col-sm-2">
            <div class="companyinfo">
              <h2><span>Famms</span></h2>
              <p>This is our project for <br> E-commerce website</p>
            </div>
          </div>
          <div class="col-sm-7">
          ...
          <div class="col-sm-3">
            <div class="address">
              ...
              <p>A Y DADABHAI TECHNICAL INSTITUTE KOSAMBA</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <div class="footer-bottom">
      <div class="container">
        <div class="row">
          ...
          <p class="pull-right">Designed by <span><a target="_blank" href=""> vatsal prajapati</a></span></p>
        </div>
      </div>
    </div>
