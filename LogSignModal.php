                      ...
                      <!-- <h4>Login Tab</h4>  -->
                       <div class="panel panel-pup">
                        ...
                        <div class="panel-footer">
                             <p align="left">&copy; <a href="">FammsTeam</a></p>
                        </div>
                    </div> 
                  </div>
                  <!-- end login panel -->
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        <div class="col-md-10">
                                          ...
                                          <div class="col-md-8">
                                             <input class="form-control input-sm" name="CUSPASS" placeholder=
                                      ...
                                      <div class="form-group">
                                       ...
                                       <div class="form-group">
                                        ...
                                        <p><input type="checkbox" id="conditionterms" name="conditionterms" value="checkbox" />
                                           <small> I Agree with the <a class="toggle-modal"  onclick=" OpenPopupCenter('terms.php','Terms And Codition','600','600')"  ><b>TERMS AND CONDITION</b></a> of NOWDEMY Source Code.</small>
